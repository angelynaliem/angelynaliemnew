...
import { AboutStyled, DescStyled, ImageStyled, HideStyled } from "../pages/styles";
        ...
        <AboutStyled>
            <DescStyled>
                <motion.div className="subject">
                    ...
                    <HideStyled>
                        <motion.h2 variants={subjectAnim} >Welcome to <span>Angelyn's</span> portfolio.</motion.h2>
                    </HideStyled>
                    {/* <HideStyled>
                        <motion.h2>Enjoy!</motion.h2>
                    </HideStyled> */}
                </motion.div>
                <motion.p variants={fadeAway}>Here, you'll learn more about me and some of the projects I've coded from scratch.</motion.p>
                <Link to="/projects">
                <motion.button href="/projects" variants={fadeAway}>Learn more</motion.button>
                </Link>
