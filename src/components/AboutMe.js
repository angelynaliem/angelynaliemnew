...
const AboutMe = () => {
    return (
        <AboutMeStyled>
            <h2>Get to know <span>Angelyn</span></h2>
            ...
            <div className="question">
                <div className="answer">
                    <p>I am a Grow With Google Scholarship Recipient for its Android Basics Nano Degree program at Udacity which I completed in 2018.</p>
                    <p>I completed my Full Stack Web Development certificate from Bloom Institute of Technology, formerly known as Lambda School, in 2021.</p>
                </div>
            </div>
            </AboutMeToggle>
            ...
            <div className="question">
             <div className="answer">
                 <p>Web Development: HTML, CSS, Java Script, React, Node, Python</p>
